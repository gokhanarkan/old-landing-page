  ...
  >
    ...
    >
      ...
      <div class="flex flex-col justify-center items-start ml-3">
        <p class="text-sm m-0 text-gray-600 mt-1">{{ artist }}</p>
        <p class="text-gray-500 dark:text-gray-300 max-w-48 truncate w-48 m-0">
          {{ title }}
        </p>
      </div>
      <svg class="h-4 w-4 ml-auto mt-1 mr-2" viewBox="0 0 168 168">
        <path
          fill="#1ED760"
